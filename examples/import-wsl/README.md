...
.\import-wsl.ps1 -RootFsPath "D:\staging\oracle-linux-8-dev-vYYYYMMDD.x.x-wsl-rootfs.tar.gz" -WslDistroName "OracleLinux8-Dev"
...
.\import-wsl.ps1 `
  -Tag "main-wsl" `
  -DownloadOnly `
  -RootFsOutputPath ".\oracle-linux-8-dev-main-wsl-rootfs.tar.gz"
```
...
.\import-wsl.ps1 -DownloadOnly -RootFsOutputPath "D:\staging\oracle-linux-8-dev-main-wsl-rootfs.tar.gz"
```
